...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleUserNotActiveException(UserNotActiveException ex, WebRequest request) {
        CustomErrorResponse errorResponse = new CustomErrorResponse(
                LocalDateTime.now(),
...
//            log.debug("Processing MedicineClientException: {}, root cause: {}", message, rootCause.getMessage());
    ...
    public ResponseEntity<CustomErrorResponse> handleInvalidCredentialsException(InvalidCredentialsException ex, WebRequest request) {
        CustomErrorResponse errorResponse = new CustomErrorResponse(
                LocalDateTime.now(),
    ...
    public ResponseEntity<CustomErrorResponse> handleSecurityException(SecurityException ex, WebRequest request) {
        CustomErrorResponse errorResponse = new CustomErrorResponse(
                LocalDateTime.now(),
                HttpStatus.FORBIDDEN.value(),
                "Forbidden",
    ...
    public ResponseEntity<CustomErrorResponse> handleAccessDeniedException(org.springframework.security.access.AccessDeniedException ex, WebRequest request) {
        CustomErrorResponse errorResponse = new CustomErrorResponse(
                LocalDateTime.now(),
                HttpStatus.FORBIDDEN.value(),
                "Forbidden",
    ...
    public ResponseEntity<CustomErrorResponse> handleBadCredentialsException(org.springframework.security.authentication.BadCredentialsException ex, WebRequest request) {
        CustomErrorResponse errorResponse = new CustomErrorResponse(
                LocalDateTime.now(),
                HttpStatus.UNAUTHORIZED.value(),
                "Unauthorized",
