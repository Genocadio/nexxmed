...
import com.nexxserve.inventoryservice.dto.sync.MedicineInsuranceCoveragePageResponse;
...
public class MedicineInsuranceCoverageSyncInService {
    ...
    private MedicineInsuranceCoveragePageResponse fetchMedicineInsuranceCoveragesFromSource() {
        try {
            String url = String.format("%s/api/sync/medicine-insurance-coverages?page=0&size=1000", getBaseUrl());
