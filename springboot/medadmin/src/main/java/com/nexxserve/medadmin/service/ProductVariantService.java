...
import com.nexxserve.medadmin.dto.catalog.ProductVariantDto;
import com.nexxserve.medadmin.dto.catalog.ProductVariantRequestDto;
...
import com.nexxserve.medadmin.mapper.ProductVariantMapper;
...
//    }
    ...
    public ProductVariantDto createProductVariant(ProductVariantRequestDto requestDto) {
        ...
        String id = jwtService.getCurrentAdminId().toString();
