...
import com.nexxserve.medicine.dto.InsuranceResponseDto;
...
public class InsuranceController {
    ...
    public ResponseEntity<InsuranceResponseDto> createInsurance(
            ...
            Principal principal) {
        Insurance insurance = insuranceService.createInsurance(requestDto, principal.getName());
    ...
    public ResponseEntity<InsuranceResponseDto> updateInsurance(
            ...
            @RequestBody InsuranceRequestDto requestDto,
            Principal principal) {
        Insurance insurance = insuranceService.updateInsurance(id, requestDto, principal.getName());
        if (insurance != null) {
